...
import type { InkPrimitivesLangError, Vouch } from "./types.js";
...
> extends InkGenericContractApi<ChainApi> {
  ...
  constructorTx: ConstructorTx<VouchContractApi, "ink">;
  events: ContractEvents<"ink">;
  storage: {
    root(): Promise<Vouch>;
    lazy(): WithLazyStorage<Vouch>;
  };

  types: {
    ChainApi: ChainApi;
    RootStorage: Vouch;
    LazyStorage: WithLazyStorage<Vouch>;
